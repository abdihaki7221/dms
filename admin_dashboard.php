                    ...
                    <div class="text-center">
                      ...
                      <div class="container-lg">
                        ...
                        <a href="#intro" class="navbar-brand">
                          ...
                          <span class="fw-bold text-white" style="font-size: 16px;">Admin Dashboard</span>
            ...
            <div class="card  shadow card-left" style="width:200px; background-color: #36454F;">
                <div class="card-body  " >
                  <ul class="nav flex-column">
                    <li class="nav-item">
                      <a class="nav-link text-white" href="admin_dashboard.php?dashboard="><i class="fa-solid fa-gauge me-1"></i>Dashboard</a>
                    </li>
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="admin_dashboard.php?add_users">Add Users</a></li>
                  <li><a class="dropdown-item" href="admin_dashboard.php?manage_users">Manage Org Users</a></li>
                </ul>
              </div>
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="admin_dashboard.php?view_doc"> Organization Documents</a></li>
                <li><a class="dropdown-item" href="admin_dashboard.php?doc_status"> Owner Documents</a></li>
              </ul>
            </div>

            <li class="nav-item">
              <a class="nav-link text-white" href="admin_dashboard.php?InActive"><i class="fa-solid fa-file-excel me-1"></i>In Active</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-white" href="admin_dashboard.php?locked"><i class="fa-solid fa-file"></i><i class="fa-solid fa-lock me-1" style="font-size:9px;"></i>Locked</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-white" href="admin_dashboard.php?active"><i class="fa-solid fa-file-circle-check me-1"></i>Active</a>
            </li>

            <li class="nav-item">
              <a class="nav-link text-white" href="reports.php"><i class="fa-solid fa-file me-1"></i> Reports</a>
            </li>
              ...
              <div class="col-sm-6 my-2 col-md-9 offset-md-0 ">
                ...
                if (isset($_GET['doc_status'])) {

                  include ('doc_status.php');
                  // code...
}
                  if (isset($_GET['active'])) {

                    include ('admin_active.php');
                    // code...
                  }
                  if (isset($_GET['locked'])) {

                    include ('admin_locked.php');
                    // code...
                  }
                  if (isset($_GET['InActive'])) {

                    include ('admin_In_active.php');
                    // code...
                  }
