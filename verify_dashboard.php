...
<body>
    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="verify_dashboard.php?verify_doc=<?php $sql = "SELECT * FROM org_users";
      ...
      ?>">Manage Documents</a></li>
                 ...
                 <!--active-->
          <li><a href="verify_dashboard.php?Verified">Verified Certificates</a></li>

                  <!--locked-->
          <li><a href="verify_dashboard.php?Not_Verify=<?php $sql = "SELECT * FROM org_users";
          $result = mysqli_query($conn,$sql);
       while ($raw_data = mysqli_fetch_assoc($result)) {
         $user_id  = $raw_data['org_id'];
          $org_name = $raw_data['org_name'];
       ...
       echo "$user_id";
      ?>">Not Verified Certificates</a></li>
  ...
  <section class="home-section mt-2" id="dash_section" >
    <div class="home-content">
      ...
      <span class="text">Verifying Org Dashboard</span>
    </div>
  </section>
  <div class="row">
  ...
  <div class="col-sm-5 my-2 col-md-9 offset-md-0 mt-3">
    ...
    if (isset($_GET['Not_Verify'])) {

      include ('Not_Verify.php');
      // code...
    }
