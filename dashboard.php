        ...
        <div class="row">
          <div class="col-sm-6 ">
            ...
            <div class='card m-1 shadow' style=' background-color: #36454F;'>
              <div class='card-body '>
                ...
                $select_cert = "SELECT * FROM org_certificates";
          ...
          <div class="col-sm-6">
            <div class="card m-1 shadow" style="background-color: #36454F;">
              <div class="card-body ">
                ...
                $select_cert = "SELECT * FROM org_certificates WHERE doc_status = 'Locked'";
                 $result_parcel_select = mysqli_query($conn,$select_cert);
                 $num_rows= mysqli_num_rows($result_parcel_select);
                 echo $num_rows;
          ...
          <div class="col-sm-6 ">
            <div class="card m-1 shadow" style="background-color: #36454F;">
              <div class="card-body ">
                ...
                <p class="card-text text-light"><?php
                        ...
                        $select_cert = "SELECT * FROM org_certificates WHERE doc_status = 'Active'";
                         $result_parcel_select = mysqli_query($conn,$select_cert);
                         $num_rows= mysqli_num_rows($result_parcel_select);
            ...
            <div class=" col-sm-6 ">
              <div class="card m-1 shadow" style="background-color: #36454F;">
                <div class="card-body ">
                  <h5 class="card-title text-light"><i class="fa-solid fa-user me-1 text-info"></i>Users</h5>
                  <p class="card-text text-light"><?php

                  $select_cert = "SELECT * FROM users ";
                   $result_parcel_select = mysqli_query($conn,$select_cert);
                   $num_rows= mysqli_num_rows($result_parcel_select);
                   echo $num_rows;
                   ?></p>
            ...
            <div class="col-sm-6 ">
              <div class="card m-1 shadow" style="background-color: #36454F;">
                <div class="card-body ">
                  <h5 class="card-title text-light"><i class="fa-solid fa-users text-light me-1"></i>Org Users</h5>
                  <p class="card-text text-light"><?php
                          ...
                          $select_cert = "SELECT * FROM org_users";
                           $result_parcel_select = mysqli_query($conn,$select_cert);
                           $num_rows= mysqli_num_rows($result_parcel_select);
