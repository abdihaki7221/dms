    ...
    <form action='' method='post'  enctype="multipart/form-data">
      ...
      <thead class='thead text-white' style='background-color: #36454F;'>
        ...
        while ($raw_data = mysqli_fetch_assoc($result)) {
                ...
                $select_cert = "SELECT * FROM org_certificates WHERE owner_id = '$owner_id' AND doc_status ='In Active' ";
                 ...
                 while ($row_items = mysqli_fetch_assoc($result_parcel_select)) {
                  ...
                  <tr>
                    ...
                    <td>
                    <a href = ''><i class='fa-solid fa-eye-slash text-dark' style='font-size:22px;'></i>
                    ...
                    <a href = ''><i class='fa-solid fa-download text-success' style='font-size:22px; '></i>
