...
<body>
  <div class="sidebar close">
    ...
    <ul class="nav-links">
      <li>
        <a href="user_dashboard.php?dashboard=<?php $sql = "SELECT * FROM usertable";
        ...
        <ul class="sub-menu blank">
          <li><a class="link_name" href="user_dashboard.php?dashboard=<?php $sql = "SELECT * FROM usertable";
          $result = mysqli_query($conn,$sql);
          while ($raw_data = mysqli_fetch_assoc($result)) {
                  $user_id  = $raw_data['id'];
                   $national_id = $raw_data['national_id'];
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="user_dashboard.php?manage_doc=<?php $sql = "SELECT * FROM usertable";
          $result = mysqli_query($conn,$sql);
          while ($raw_data = mysqli_fetch_assoc($result)) {
                  $user_id  = $raw_data['id'];
                   $national_id = $raw_data['national_id'];
                 ...
                 <!--active-->
          <li><a href="user_dashboard.php?active=<?php $sql = "SELECT * FROM usertable";
          $result = mysqli_query($conn,$sql);
          while ($raw_data = mysqli_fetch_assoc($result)) {
                  $user_id  = $raw_data['id'];
                   $national_id = $raw_data['national_id'];
                 ...
                 ?>">Active Certificates</a></li>
                  ...
                  <!--locked-->
          <li><a href="user_dashboard.php?locked=<?php $sql = "SELECT * FROM usertable";
          $result = mysqli_query($conn,$sql);
          while ($raw_data = mysqli_fetch_assoc($result)) {
                  $user_id  = $raw_data['id'];
                   $national_id = $raw_data['national_id'];
          ...
          <li><a href="user_dashboard.php?inActive=<?php $sql = "SELECT * FROM usertable";
          $result = mysqli_query($conn,$sql);
          while ($raw_data = mysqli_fetch_assoc($result)) {
                  $user_id  = $raw_data['id'];
                   $national_id = $raw_data['national_id'];
