...
$cert_id = $_GET['cert_id'];
  ...
  $msg="";
  $sql = "SELECT * FROM org_certificates WHERE cert_id= '$cert_id'";
  $sql_result = mysqli_query($conn,$sql);
  $rows = mysqli_fetch_assoc($sql_result);
  $cert_title = $rows['cert_title'];
  $cert_id = $rows['cert_id'];
  $org_cert = $rows['org_name'];
  $cert_doc = $rows['cert_file'];
  $owner_id = $rows['owner_id'];
  $doc_status = $rows['doc_status'];
  ...
  if (isset($_POST['update'])) {
    ...
    $sql_update = "UPDATE org_certificates set cert_title = '$cert_title',
    org_name = '$org_cert',cert_file='$product_image',owner_id='$owner_id',doc_status='$doc_status'
          ...
          <div class="card" style="">
            <div class="card-body">
              ...
              <form method="post" enctype="multipart/form-data">
                  ...
                  <!--owner id-->
                  <label for="formGroupExampleInput " class="text-primary">Owner ID </label>
               <div class="input-group mb-3" id="inputGroup-sizing-default">


                  <input type="text text-dark" class="form-control" name="owner_id"  value="<?php echo "$owner_id";?>"  aria-label="Username" aria-describedby="basic-addon1" required ="required">
               ...
               <div class="input-group mb-3 mt-3" id="inputGroup-sizing-default">
                 ...
                 <div class="me-1 ms-1">
                    ...
                    <div class="mt-2">
                      <a href="org_dashboard.php?manage_doc=<?php  $sql = "SELECT * FROM org_users";
